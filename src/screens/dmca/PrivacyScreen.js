  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.text}>
        Subhdeals built the {config.App_Name} app as an Ad Supported app. This
        SERVICE is provided by Subhdeals at no cost and is intended for use as
        ...
        Conditions, which are accessible at {config.App_Name} unless otherwise
      ...
      <Text style={styles.text}>
        ...
        but not limited to Device Info, IP Address. The information that we
      ...
      <Text style={styles.text}>
        ...
        policy is effective as of 2022-07-25
      </Text>
      <Text style={styles.heading}>Contact Us</Text>
      <Text style={styles.text}>
        If you have any questions or suggestions about our Privacy Policy, do
        not hesitate to contact us at info@subhdeals.com.
      </Text>
    </ScrollView>
  );
};
