  ...
  return (
      <ScrollView style={styles.container}>
        ...
        <Text style={styles.text}>
          ...
          related to it, still belong to Subhdeals. Subhdeals is committed to
        ...
        />
        <Text style={styles.text}>
          You should be aware that there are certain things that Subhdeals will
          ...
          Wi-Fi or provided by your mobile network provider, but Subhdeals cannot
          ...
          from the bill payer for using the app. Along the same lines, Subhdeals
          ...
          battery and you can’t turn it on to avail the Service, Subhdeals cannot
          accept responsibility. With respect to Subhdeals’s responsibility for
          ...
          information to us so that we can make it available to you. Subhdeals
          ...
          keep using the app. Subhdeals does not promise that it will always
